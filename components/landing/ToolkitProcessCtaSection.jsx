...
export default function ToolkitProcessCtaSection({
  ...
  const capabilities = [
    { name: t("Smart AI"), icon: Cpu },
    { name: t("Instant Chat"), icon: Zap },
    { name: t("Remembers You"), icon: RefreshCw },
    { name: t("100% Private"), icon: Shield },
    { name: t("Group Chats"), icon: Layers },
    { name: `${charCount}+ ${t("Characters")}`, icon: Bot },
    { name: t("Natural Talking"), icon: MessageSquare },
    { name: t("Always Online"), icon: Star }
  ];

  const steps = [
    { num: "01", title: t("PICK CHARACTER"), desc: t("Pick any character — study tutor, college bestie, or fun game.") },
    { num: "02", title: t("SET PREFERENCE"), desc: t("Choose your favorite chat style, language, or topic.") },
    { num: "03", title: t("START CHATTING"), desc: t("Start talking instantly with zero waiting time.") },
    { num: "04", title: t("LEARN & ENJOY"), desc: t("Solve physics problems, gossip, or play story games.") }
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-4 p-6 rounded-2xl bg-neutral-900/60 border border-purple-500/15 backdrop-blur-md flex flex-col justify-between">
          ...
          <div className="pt-6 mt-6 border-t border-neutral-800 text-[11px] font-mono text-neutral-400">
            {t("PLATFORM STATUS: ONLINE & READY 24/7")}
          </div>
        </div>
        ...
        <div className="lg:col-span-4 p-6 rounded-2xl bg-neutral-900/60 border border-purple-500/15 backdrop-blur-md flex flex-col justify-between">
          ...
          <div className="pt-6 mt-6 border-t border-neutral-800 text-[11px] font-mono text-neutral-400">
            {t("SIMPLE • FAST • PRIVATE")}
          </div>
        </div>

        {/* Column 3: Vibrant Solid Purple CTA Block */}
